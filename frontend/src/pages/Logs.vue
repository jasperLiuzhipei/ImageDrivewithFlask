<template>
  <el-card>
    <div class="title"><el-icon><List /></el-icon><span>日志</span></div>
    <div class="toolbar">
      <el-select v-model="action" placeholder="动作" clearable style="width:200px" @change="load">
...
function exportCsv() {
  ...
  window.open(`/api/v1/logs/export${q}`, '_blank')
}
